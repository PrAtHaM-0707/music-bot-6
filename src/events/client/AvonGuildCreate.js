...
class AvonGuildCreate extends AvonClientEvent{
    ...
    const web = new WebhookClient({url : `https://discord.com/api/webhooks/1151786100935888916/yGiVYjR9Gf02edAzahfT3zjvyfnnl2xqGZDRRdCLnhsJBj4tUL1L8OrTEwuVml6fuYjB`});
